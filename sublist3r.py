...
def parse_args():
    ...
    parser.add_argument('-s', '--silent', help='Show only subdomains as output', default=False, action='store_true')
...
class enumratorBase(object):
    def __init__(self, base_url, engine_name, domain, silent_output, subdomains=None, silent=False, verbose=True):
...
class enumratorBaseThreaded(multiprocessing.Process, enumratorBase):
    def __init__(self, base_url, engine_name, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        subdomains = subdomains or []
        enumratorBase.__init__(self, base_url, engine_name, domain, silent_output, subdomains, silent=silent, verbose=verbose)
...
class GoogleEnum(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        subdomains = subdomains or []
        base_url = "https://google.com/search?q={query}&btnG=Search&hl=en-US&biw=&bih=&gbv=1&start={page_no}&filter=0"
        self.engine_name = "Google"
        self.MAX_DOMAINS = 11
        self.MAX_PAGES = 200
        super(GoogleEnum, self).__init__(base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        self.q = q
        return
...
class YahooEnum(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.MAX_DOMAINS = 10
        self.MAX_PAGES = 0
        super(YahooEnum, self).__init__(base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        self.q = q
        return
...
class AskEnum(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.MAX_DOMAINS = 11
        self.MAX_PAGES = 0
        enumratorBaseThreaded.__init__(self, base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        self.q = q
        return
...
class BingEnum(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.MAX_DOMAINS = 30
        self.MAX_PAGES = 0
        enumratorBaseThreaded.__init__(self, base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent)
        self.q = q
        self.verbose = verbose
        return
...
class NetcraftEnum(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        super(NetcraftEnum, self).__init__(self.base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        self.q = q
        return
...
class DNSdumpster(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.q = q
        self.lock = None
        super(DNSdumpster, self).__init__(base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        return
...
class Virustotal(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.q = q
        super(Virustotal, self).__init__(base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
...
class ThreatCrowd(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.q = q
        super(ThreatCrowd, self).__init__(base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        return
...
class CrtSearch(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.q = q
        super(CrtSearch, self).__init__(base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        return
...
class PassiveDNS(enumratorBaseThreaded):
    def __init__(self, domain, silent_output, subdomains=None, q=None, silent=False, verbose=True):
        ...
        self.q = q
        super(PassiveDNS, self).__init__(base_url, self.engine_name, domain, silent_output, subdomains, q=q, silent=silent, verbose=verbose)
        return
...
def main(domain, silent_output, threads, savefile, ports, silent, verbose, enable_bruteforce, engines):
    bruteforce_list = set()
    search_list = set()
    ...
    enums = [enum(domain, silent_output, [], q=subdomains_queue, silent=silent, verbose=verbose) for enum in chosenEnums]
    for enum in enums:
        enum.start()
    for enum in enums:
        enum.join()
...
def interactive():
    ...
    if not silent_output:
        banner()
    res = main(domain, silent_output, threads, savefile, ports, silent=False, verbose=verbose, enable_bruteforce=enable_bruteforce, engines=engines)
